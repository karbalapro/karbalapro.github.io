...
export default function ZiyaratReader({ params }: { params: Promise<{ id: string }> }) {
    ...
    <div className="min-h-screen bg-background py-12 px-4 sm:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-12 bg-white/5 p-4 rounded-2xl border border-white/10">
          <Link href="/ziyarat" className="flex items-center gap-2 text-white/70 hover:text-white transition-colors">
